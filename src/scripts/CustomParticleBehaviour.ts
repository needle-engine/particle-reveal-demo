import { Behaviour, CircularBuffer, getTempVector, Mathf, ParticleSystem, ParticleSystemBaseBehaviour, PointerEventData, QParticle, registerType, serializable } from "@needle-tools/engine";
